...
export default function ChatbotWidget() {
  ...
  return (
    <>
      ...
      {open && (
        <div className={
            // Mobile: full width, bottom. Desktop: smaller and centered.
            "fixed inset-x-0 bottom-0 z-[9999] w-full max-w-full h-[70vh] sm:bottom-6 sm:right-6 sm:w-[98vw] sm:max-w-md md:max-w-lg sm:h-[500px] rounded-t-xl sm:rounded-lg bg-white shadow-2xl flex flex-col overflow-hidden"
          }>
          {/* Header */}
          ...
          <div className="flex-1 overflow-y-auto px-2 py-3 sm:px-4 sm:py-4 bg-gray-50">
            {messages.map((msg, idx) => (
              ...
              >
                <div
                  className={`max-w-[85vw] sm:max-w-[75%] px-3 py-2 rounded-lg text-sm sm:text-base ${
                    msg.from === 'user'
